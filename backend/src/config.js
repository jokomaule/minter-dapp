...
const extraMetadata = {
  external_url: "https://randomrabbits.io", // Replace with your website or remove this line if you do not have one.
};
...
const PUBLIC_MINT_START_DATE = "2022-03-20T00:00:01+00:00"; // This is required. Eg: 2022-02-08T11:30:48+00:00

// OPTIONAL CONTRACT DETAILS THAT CAN BE UPDATED LATER.
const PRESALE_MINT_START_DATE = null; // Optional. Eg: 2022-02-08T11:30:48+00:00
const ROYALTY_SHARE = 777; // Percentage of the token price that goes to the royalty address. 100 bps = 1%
const ROYALTY_ADDRESS = "0x030D0C324260a7d90dd68c7daa6EAf5ffea10Bd0"; // Address that will receive the royalty
const BASE_URI = null; // only update if you want to manually set the base uri
const PREREVEAL_TOKEN_URI = null; // only update if you want to manually set the prereveal token uri
const PRESALE_WHITELISTED_ADDRESSES = []; // only update if you want to manually set the whitelisted addresses

// ** OPTIONAL **
let CONTRACT_ADDRESS = "0x5DcE4A6a5FD78D5A71651d97c78A2cE0d8154404"; // If you want to manually include it
